...
# Specify the Discord client class for the bot:
class discordClient(discord.Client):
    def __init__(self) -> None:
        ...
        self.chatBot = Client(provider = RetryProvider([FreeGpt, ChatgptNext, AItianhuSpace, OpenaiChat, Bing, You], shuffle=False))
        self.chatModel = os.getenv("MODEL")
        self.conversation_history = []
        self.current_channel = None

        # Bot will watch for activity:
        ...
        # Setup for bot's startup prompt:
    ...
    async def send_start_prompt(self):
        ...
        try:
            if self.starting_prompt and discord_channel_id:
                ...
                logger.info(f"No starting prompt given or no Discord channel selected. Skipping sending system prompt.")
        except Exception as e:
